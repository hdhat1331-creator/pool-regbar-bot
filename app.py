...
# ========== تنظیمات Supabase (با اطلاعات خودت پر کن) ==========
SUPABASE_URL = "https://eqhhthempcgwlwrdxjfk.supabase.co"
SUPABASE_KEY = "sb_publishable_TWu37zVN8SVUjWuAFrIjmg_-5TYwpa1"
...
def load_db(table_name):
    try:
        ...
        print(f"❌ خطا در load_db ({table_name}): {e}")
        return {}
...
def save_db(table_name, data):
    try:
        ...
        print(f"❌ خطا در save_db ({table_name}): {e}")
        return False
...
if __name__ == "__main__":
    print("🤖 ربات پول رگبار با Supabase در حال راه‌اندازی...")
